...
public class ServletUtils {
    ...
    public static String getJsonWebToken() {
        return getJsonWebToken(ServletUtils.getRequest());
    }
    ...
    public static String getJsonWebToken(HttpServletRequest request) {
        ...
        return replaceTokenPrefix(jwt);
    }

    public static String getJsonWebToken(ServerHttpRequest request) {
     ...
     * 裁剪token前缀
     */
    public static String replaceTokenPrefix(String jwt) {
        // 如果前端设置了令牌前缀，则裁剪掉前缀
        final String prefix = "Bearer ";
        if (StrUtil.isNotBlank(jwt) && jwt.startsWith(prefix)) {
            jwt = jwt.replaceFirst(prefix, "");
        }
        return jwt;
    }
